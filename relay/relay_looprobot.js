...
function itemOrItemsBallsMacroPredicate(itemOrItems) {
  if (Array.isArray(itemOrItems)) {
    if (itemOrItems[0] === itemOrItems[1])
      return "hastwocombatitems ".concat(itemOrItems[0]);
  ...
  _createClass5(Macro2, [{
    ...
    value: (
      ...
      function step() {
        ...
        (_this$components = this.components).push.apply(_this$components, _toConsumableArray3(nextStepsStrings.filter(Boolean)));
        return this;
      }
    )
    /**
...
var OutfitLRUCache = /* @__PURE__ */ function() {
  ...
  _createClass6(OutfitLRUCache2, [{
    ...
    value: function promote(index) {
      _classPrivateFieldSet(_useHistory, this, [index].concat(_toConsumableArray4(_classPrivateFieldGet(_useHistory, this).filter(function(i2) {
        return i2 !== index;
      }))));
...
function maximizeCached(objectives) {
  ...
  var objective = _toConsumableArray4(new Set([].concat(_toConsumableArray4(objectives.sort()), _toConsumableArray4(forceEquip.map(function(item) {
  ...
  var cacheKey = [objective].concat(_toConsumableArray4(untouchedSlots.map(function(slot) {
  ...
  _createClass8(Outfit2, [{
    ...
    value: (
      ...
      function equippedAmount3(item) {
        return _toConsumableArray6(this.equips.values()).filter(function(i2) {
          return i2 === item;
        }).length;
      }
    )
    ...
    value: function equipAccessory(item, slot) {
      var _this = this;
      if (![void 0].concat(_toConsumableArray6($slots(_templateObject72 || (_templateObject72 = _taggedTemplateLiteral3(["acc1, acc2, acc3"]))))).includes(slot))
        return false;
    ...
    value: function equipUsingDualWield(item, slot) {
      if (![void 0, $slot(_templateObject103 || (_templateObject103 = _taggedTemplateLiteral3(["off-hand"])))].includes(slot))
        return false;
    ...
    value: function _dress(refreshed) {
      ...
      var crown = this.riders.get($slot(_templateObject362 || (_templateObject362 = _taggedTemplateLiteral3(["crown-of-thrones"]))));
