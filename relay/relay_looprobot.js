...
// node_modules/mafia-shared-relay/dist/index.js
var require_dist = __commonJS({
  "node_modules/mafia-shared-relay/dist/index.js": function(exports, module) {
    (function() {
      "use strict";
      var __webpack_modules__ = {
        ...
        530: (
          /***/
          function(module2) {
            module2.exports = require("kolmafia");
          }
        )
        /******/
      };
      ...
      (function() {
        ...
        var kolmafia__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(530);
        var kolmafia__WEBPACK_IMPORTED_MODULE_0___default = /* @__PURE__ */ __webpack_require__.n(kolmafia__WEBPACK_IMPORTED_MODULE_0__);
        ...
        function validateComponents(components) {
          var _iterator2 = _createForOfIteratorHelper(components), _step2;
          try {
        ...
        function _generateHTML(pages, extraHtml) {
          pages = pages.filter(function(p) {
            return p != null;
          });
          var _iterator3 = _createForOfIteratorHelper(pages), _step3;
          try {
          ...
          buffer.push("<script>");
          buffer.push("let getData = function(callback) {callback(".concat(JSON.stringify(pages), ")}"));
          buffer.push("document.onclick = (e) => {\n    if(e.target.classList.contains('notification')) e.target.remove();\n  }");
          buffer.push("</script>");
          buffer.push('<script src="'.concat(__webpack_require__(447), '"></script>'));
          return buffer.join("\n");
        }
        function _getPagePath(file) {
          var fileName = file.includes("/") ? file : "relay/shared_relay/pages/" + file + ".json";
        ...
        function _parsePageFromFile(file) {
          var data2 = (0, kolmafia__WEBPACK_IMPORTED_MODULE_0__.fileToBuffer)(_getPagePath(file));
          return _parsePageFromJson(file, data2);
        }
        function _parseCssFromFile(file) {
          var fileName = file.includes("/") ? file : "shared_relay/pages/" + file + ".css";
          if (!fileName.endsWith(".css")) {
            fileName += ".css";
          }
          var data2 = (0, kolmafia__WEBPACK_IMPORTED_MODULE_0__.fileToBuffer)(fileName);
          if (data2.length == 0) {
            return null;
          }
          return fileName;
        ...
        function _parsePageFromJson(id, jsonData) {
          ...
          subpage.file = id;
          for (var _i2 = 0, _arr2 = subpage.components; _i2 < _arr2.length; _i2++) {
            var _button$dropdown;
            ...
            if (button.dropdown == null) {
              ...
              button.dropdown = button.dropdown.map(function(s) {
            ...
            var data = eval(button.dropdownFiller).map(function(_ref) {
              var _ref2 = _slicedToArray(_ref, 2), display = _ref2[0], value = _ref2[1];
  ...
  _createClass(Args2, null, [{
    ...
    value: function create(scriptName2, scriptHelp, args2, options) {
      ...
      if (options === null || options === void 0 ? void 0 : options.positionalArgs) {
        ...
        var _iterator22 = _createForOfIteratorHelper2(options.positionalArgs), _step22;
        try {
    ...
    key: "fill",
    value: function fill(args2, command) {
...
function _traverse(spec, process, onGroup) {
  ...
  for (var _i22 = 0, _groups2 = groups; _i22 < _groups2.length; _i22++) {
    var group_and_key = _groups2[_i22];
...
var CommandParser = /* @__PURE__ */ function() {
  ...
  _createClass(CommandParser2, [{
    ...
    value: function findNext(searchValue) {
      ...
      var _iterator4 = _createForOfIteratorHelper2(searchValue), _step4;
      try {
...
var PropertiesManager = /* @__PURE__ */ function() {
  ...
  _createClass3(PropertiesManager2, [{
    ...
    value: function set(propertiesToSet) {
      for (var _i22 = 0, _Object$entries2 = Object.entries(propertiesToSet); _i22 < _Object$entries2.length; _i22++) {
        var _Object$entries2$_i = _slicedToArray2(_Object$entries2[_i22], 2), propertyName = _Object$entries2$_i[0], propertyValue = _Object$entries2$_i[1];
    ...
    value: function resetAll() {
      this.reset.apply(this, _toConsumableArray2(Object.keys(this.properties)));
    }
    /**
...
function setEqual(a, b) {
  var sortedA = _toConsumableArray3(a).sort();
  var sortedB = _toConsumableArray3(b).sort();
...
function splitByCommasWithEscapes(str) {
  ...
  var currentString = "";
  var _iterator22 = _createForOfIteratorHelper3(str.split("")), _step22;
  try {
    for (_iterator22.s(); !(_step22 = _iterator22.n()).done; ) {
...
function makeByXFunction(source) {
  return function(options, alternateSource) {
    var _options$val;
    var val2 = undelay(alternateSource !== null && alternateSource !== void 0 ? alternateSource : source);
    if ("default" in options)
      return (_options$val = options[val2]) !== null && _options$val !== void 0 ? _options$val : options.default;
    return options[val2];
  };
}
...
var concatTemplateString = function concatTemplateString2(literals) {
  ...
  return literals.raw.reduce(function(acc, literal, i2) {
    var _placeholders$i;
    return acc + literal + ((_placeholders$i = placeholders[i2]) !== null && _placeholders$i !== void 0 ? _placeholders$i : "");
  }, "");
};
...
var $bounty = createSingleConstant(import_kolmafia4.Bounty, import_kolmafia4.toBounty);
var $bounties = createPluralConstant(import_kolmafia4.Bounty);
var $class = createSingleConstant(import_kolmafia4.Class, import_kolmafia4.toClass);
var $classes = createPluralConstant(import_kolmafia4.Class);
var $coinmaster = createSingleConstant(import_kolmafia4.Coinmaster, import_kolmafia4.toCoinmaster);
var $coinmasters = createPluralConstant(import_kolmafia4.Coinmaster);
var $effect = createSingleConstant(import_kolmafia4.Effect, import_kolmafia4.toEffect);
var $effects = createPluralConstant(import_kolmafia4.Effect);
var $element = createSingleConstant(import_kolmafia4.Element, import_kolmafia4.toElement);
var $elements = createPluralConstant(import_kolmafia4.Element);
var $familiar = createSingleConstant(import_kolmafia4.Familiar, import_kolmafia4.toFamiliar);
var $familiars = createPluralConstant(import_kolmafia4.Familiar);
var $item = createSingleConstant(import_kolmafia4.Item, import_kolmafia4.toItem);
var $items = createPluralConstant(import_kolmafia4.Item);
var $location = createSingleConstant(import_kolmafia4.Location, import_kolmafia4.toLocation);
var $locations = createPluralConstant(import_kolmafia4.Location);
var $modifier = createSingleConstant(import_kolmafia4.Modifier, import_kolmafia4.toModifier);
var $modifiers = createPluralConstant(import_kolmafia4.Modifier);
var $monster = createSingleConstant(import_kolmafia4.Monster, import_kolmafia4.toMonster);
var $monsters = createPluralConstant(import_kolmafia4.Monster);
var $path = createSingleConstant(import_kolmafia4.Path, import_kolmafia4.toPath);
var $paths = createPluralConstant(import_kolmafia4.Path);
var $phylum = createSingleConstant(import_kolmafia4.Phylum, import_kolmafia4.toPhylum);
var $phyla = createPluralConstant(import_kolmafia4.Phylum);
var $servant = createSingleConstant(import_kolmafia4.Servant, import_kolmafia4.toServant);
var $servants = createPluralConstant(import_kolmafia4.Servant);
var $skill = createSingleConstant(import_kolmafia4.Skill, import_kolmafia4.toSkill);
var $skills = createPluralConstant(import_kolmafia4.Skill);
var $slot = createSingleConstant(import_kolmafia4.Slot, import_kolmafia4.toSlot);
var $slots = createPluralConstant(import_kolmafia4.Slot);
var $stat = createSingleConstant(import_kolmafia4.Stat, import_kolmafia4.toStat);
var $stats = createPluralConstant(import_kolmafia4.Stat);
var $thrall = createSingleConstant(import_kolmafia4.Thrall, import_kolmafia4.toThrall);
...
function _wrapNativeSuper(Class5) {
  ...
  _wrapNativeSuper = function _wrapNativeSuper3(Class6) {
...
function _slicedToArray3(arr, i2) {
  return _arrayWithHoles3(arr) || _iterableToArrayLimit3(arr, i2) || _unsupportedIterableToArray5(arr, i2) || _nonIterableRest3();
}
...
function makeScalerCalcFunction(cache, pattern) {
  return function(monster) {
    ...
    if (current !== void 0)
      return (0, import_kolmafia5.monsterEval)(current);
...
var makeBulkFunction = function(action) {
  return function(items) {
    ...
    var _iterator22 = _createForOfIteratorHelper4(items.entries()), _step22;
    try {
      for (_iterator22.s(); !(_step22 = _iterator22.n()).done; ) {
        var _step2$value = _slicedToArray3(_step22.value, 2), item = _step2$value[0], quantity = _step2$value[1];
...
var bulkAutosell = makeBulkFunction(import_kolmafia5.autosell);
var bulkPutCloset = makeBulkFunction(import_kolmafia5.putCloset);
var bulkPutDisplay = makeBulkFunction(import_kolmafia5.putDisplay);
var bulkPutStash = makeBulkFunction(import_kolmafia5.putStash);
var bulkTakeCloset = makeBulkFunction(import_kolmafia5.takeCloset);
var bulkTakeDisplay = makeBulkFunction(import_kolmafia5.takeDisplay);
var bulkTakeShop = makeBulkFunction(import_kolmafia5.takeShop);
var bulkTakeStash = makeBulkFunction(import_kolmafia5.takeStash);
var bulkTakeStorage = makeBulkFunction(import_kolmafia5.takeStorage);
...
function _wrapNativeSuper2(Class5) {
  var _cache = typeof Map === "function" ? /* @__PURE__ */ new Map() : void 0;
  _wrapNativeSuper2 = function _wrapNativeSuper3(Class6) {
...
function itemOrItemsBallsMacroPredicate(itemOrItems) {
  if (Array.isArray(itemOrItems)) {
    if (itemOrItems[0] === itemOrItems[1])
      return "hastwocombatitems ".concat(itemOrItemsBallsMacroName(itemOrItems[0]));
...
var Macro = /* @__PURE__ */ function() {
  ...
  _createClass5(Macro2, [{
    ...
    value: function setAutoAttack3() {
      var id2 = Macro2.cachedMacroIds.get(this.name);
      if (id2 === void 0) {
        id2 = getMacroId(this.name);
        Macro2.cachedMacroIds.set(this.name, id2);
      }
      if ((0, import_kolmafia6.getAutoAttack)() === 99e6 + id2 && this.toString() === Macro2.cachedAutoAttacks.get(this.name)) {
        return;
      }
      (0, import_kolmafia6.visitUrl)("account_combatmacros.php?macroid=".concat(id2, "&name=").concat((0, import_kolmafia6.urlEncode)(this.name), "&macrotext=").concat((0, import_kolmafia6.urlEncode)(this.toString()), "&action=save"), true, true);
      (0, import_kolmafia6.visitUrl)("account.php?am=1&action=autoattack&value=".concat(99e6 + id2, "&ajax=1"));
    ...
    value: function skill() {
      ...
      return this.step.apply(this, _toConsumableArray4(skills.map(function(skill2) {
    ...
    value: (
      ...
      function trySkill() {
        ...
        return this.step.apply(this, _toConsumableArray4(skills.map(function(skillOrName) {
    ...
    value: (
      ...
      function tryItem() {
        ...
        return this.step.apply(this, _toConsumableArray4(items.map(function(item) {
    ...
    value: function clearAutoAttackMacros() {
      var _iterator = _createForOfIteratorHelper5(Macro2.cachedAutoAttacks.keys()), _step;
      try {
        for (_iterator.s(); !(_step = _iterator.n()).done; ) {
          var _Macro$cachedMacroIds;
          var name = _step.value;
          var id2 = (_Macro$cachedMacroIds = Macro2.cachedMacroIds.get(name)) !== null && _Macro$cachedMacroIds !== void 0 ? _Macro$cachedMacroIds : getMacroId(name);
          (0, import_kolmafia6.visitUrl)("account_combatmacros.php?macroid=".concat(id2, "&action=edit&what=Delete&confirm=1"));
    ...
    value: function makeBALLSPredicate(condition) {
      if (condition instanceof import_kolmafia6.Monster) {
        ...
        if (condition[0] instanceof import_kolmafia6.Item)
          return itemOrItemsBallsMacroPredicate(condition);
...
function toMaximizerName(_ref) {
  var name = _ref.name, id2 = _ref.id;
  return name.includes(";") ? "\xB6".concat(id2) : name;
}
function mergeMaximizeOptions(defaultOptions, addendums) {
  ...
  return {
    ...
    preventEquip: [].concat(_toConsumableArray5(defaultOptions.preventEquip), _toConsumableArray5((_addendums$preventEqu = addendums.preventEquip) !== null && _addendums$preventEqu !== void 0 ? _addendums$preventEqu : [])).filter(function(item) {
...
function getCurrentModes() {
  var modes = {};
  var _iterator = _createForOfIteratorHelper6(modeableCommands), _step;
  try {
    for (_iterator.s(); !(_step = _iterator.n()).done; ) {
      var key = _step.value;
...
function applyModes(modes) {
  var _iterator22 = _createForOfIteratorHelper6(modeableCommands), _step22;
  try {
    for (_iterator22.s(); !(_step22 = _iterator22.n()).done; ) {
...
var OutfitLRUCache = /* @__PURE__ */ function() {
  ...
  _createClass6(OutfitLRUCache2, [{
    ...
    value: function promote(index) {
      _classPrivateFieldSet(_useHistory, this, [index].concat(_toConsumableArray5(_classPrivateFieldGet(_useHistory, this).filter(function(i2) {
        return i2 !== index;
      }))));
...
function canEquipItemCount() {
  ...
  cachedStats = stats;
  cachedCanEquipItemCount = import_kolmafia7.Item.all().filter(function(item) {
...
function applyCached(entry, options) {
  ...
  if (outfitName) {
    ...
    var _iterator3 = _createForOfIteratorHelper6(entry.equipment), _step3;
    try {
      for (_iterator3.s(); !(_step3 = _iterator3.n()).done; ) {
        var _step3$value = _slicedToArray4(_step3.value, 2), slot = _step3$value[0], item = _step3$value[1];
        if ((0, import_kolmafia7.equippedItem)(slot) !== item && (0, import_kolmafia7.availableAmount)(item) > 0) {
          (0, import_kolmafia7.equip)(slot, item);
        }
      }
    } catch (err) {
      _iterator3.e(err);
...
function verifyCached(entry) {
  ...
  var success = true;
  var _iterator4 = _createForOfIteratorHelper6(slotStructure), _step4;
  try {
    for (_iterator4.s(); !(_step4 = _iterator4.n()).done; ) {
...
function saveCached(cacheKey, options) {
  ...
  var _iterator5 = _createForOfIteratorHelper6(cachedSlots), _step5;
  try {
  ...
  if ((0, import_kolmafia7.equippedAmount)($item(_templateObject352 || (_templateObject352 = _taggedTemplateLiteral2(["card sleeve"])))) > 0) {
    equipment.set($slot(_templateObject362 || (_templateObject362 = _taggedTemplateLiteral2(["card-sleeve"]))), (0, import_kolmafia7.equippedItem)($slot(_templateObject37 || (_templateObject37 = _taggedTemplateLiteral2(["card-sleeve"])))));
  }
  ...
  if (options.preventSlot && options.preventSlot.length > 0) {
    var _iterator6 = _createForOfIteratorHelper6(options.preventSlot), _step6;
    try {
  ...
  if (options.onlySlot && options.onlySlot.length > 0) {
    var _iterator7 = _createForOfIteratorHelper6(import_kolmafia7.Slot.all()), _step7;
    try {
...
function maximizeCached(objectives) {
  ...
  var objective = _toConsumableArray5(new Set([].concat(_toConsumableArray5(objectives.sort()), _toConsumableArray5(forceEquip.map(function(item) {
    return '"equip '.concat(toMaximizerName(item), '"');
  }).sort()), _toConsumableArray5(preventEquip.map(function(item) {
    return '-"equip '.concat(toMaximizerName(item), '"');
  ...
  }).sort()), [have($effect(_templateObject50 || (_templateObject50 = _taggedTemplateLiteral2(["Offhand Remarkable"])))), options.updateOnLocationChange && (0, import_kolmafia7.myLocation)()]).join("; ");
  ...
  _createClass7(CombatStrategy2, [{
    ...
    value: function macro(_macro, monsters, prepend) {
      ...
      if (monsters === void 0) {
        ...
        if (monsters instanceof import_kolmafia8.Monster)
          monsters = [monsters];
    ...
    value: function autoattack(macro, monsters, prepend) {
      ...
      if (monsters === void 0) {
        ...
        if (monsters instanceof import_kolmafia8.Monster)
          monsters = [monsters];
        var _iterator22 = _createForOfIteratorHelper7(monsters), _step22;
        try {
          for (_iterator22.s(); !(_step22 = _iterator22.n()).done; ) {
    ...
    value: function action(_action, monsters) {
      ...
      } else if (monsters instanceof import_kolmafia8.Monster) {
    ...
    value: function clone() {
      ...
      if (this.starting_macro)
        result.starting_macro = _toConsumableArray6(this.starting_macro);
      if (this.default_macro)
        result.default_macro = _toConsumableArray6(this.default_macro);
      ...
      if (this.default_autoattack)
        result.default_autoattack = _toConsumableArray6(this.default_autoattack);
    ...
    value: function compile(resources, defaults, location) {
      ...
      if (this.starting_macro) {
        result.step.apply(result, _toConsumableArray6(this.starting_macro.map(function(macro2) {
      ...
      if (this.default_macro)
        result.step.apply(result, _toConsumableArray6(this.default_macro.map(function(macro2) {
          return undelay(macro2);
        })));
    ...
    value: function compileAutoattack() {
      ...
      result.step(monster_macros.compile());
      if (this.default_autoattack)
        result.step.apply(result, _toConsumableArray6(this.default_autoattack.map(function(macro) {
          return undelay(macro);
        })));
      return result;
    }
    ...
    value: function withActions(actions) {
      var CombatStrategyWithActions = /* @__PURE__ */ function(_this) {
        ...
        function CombatStrategyWithActions2() {
          _classCallCheck7(this, CombatStrategyWithActions2);
...
var CompressedMacro = /* @__PURE__ */ function() {
  function CompressedMacro2() {
    _classCallCheck7(this, CompressedMacro2);
    this.components = /* @__PURE__ */ new Map();
  }
  _createClass7(CompressedMacro2, [{
    key: "add",
...
var CombatResources = /* @__PURE__ */ function() {
  function CombatResources2() {
    _classCallCheck7(this, CombatResources2);
    this.resources = /* @__PURE__ */ new Map();
  }
  _createClass7(CombatResources2, [{
    key: "provide",
    ...
    value: function getMacro(action) {
      ...
      if (resource === void 0)
        return void 0;
      if (resource.do instanceof import_kolmafia8.Item)
        return new Macro().item(resource.do);
      if (resource.do instanceof import_kolmafia8.Skill)
...
function _slicedToArray5(arr, i2) {
  return _arrayWithHoles5(arr) || _iterableToArrayLimit5(arr, i2) || _unsupportedIterableToArray9(arr, i2) || _nonIterableRest5();
}
...
var weaponHands = function(i2) {
  return i2 ? (0, import_kolmafia9.weaponHands)(i2) : 0;
};
var modeableCommands2 = ["backupcamera", "umbrella", "snowsuit", "edpiece", "retrocape", "parka", "jillcandle"];
var Outfit = /* @__PURE__ */ function() {
  function Outfit2() {
    _classCallCheck8(this, Outfit2);
  ...
  _createClass8(Outfit2, [{
    key: "equippedAmount",
    value: (
      /**
       * Check how many of an item is equipped on the outfit.
       */
      function equippedAmount3(item) {
        return _toConsumableArray7(this.equips.values()).filter(function(i2) {
          return i2 === item;
        }).length;
      }
    )
    ...
    value: function isAvailable(item) {
      var _a;
      if ((_a = this.avoid) === null || _a === void 0 ? void 0 : _a.includes(item))
        return false;
      if (!have(item, this.equippedAmount(item) + 1))
        return false;
      if ((0, import_kolmafia9.booleanModifier)(item, "Single Equip") && this.equippedAmount(item) > 0)
        return false;
      return true;
    }
    /**
    ...
    key: "haveEquipped",
    value: function haveEquipped3(item, slot) {
      if (slot === void 0)
        return this.equippedAmount(item) > 0;
    ...
    value: function equipNonAccessory(item, slot) {
      if ($slots(_templateObject51 || (_templateObject51 = _taggedTemplateLiteral3(["acc1, acc2, acc3"]))).includes((0, import_kolmafia9.toSlot)(item)))
        return false;
      if (slot !== void 0 && slot !== (0, import_kolmafia9.toSlot)(item))
        return false;
      if (this.equips.has((0, import_kolmafia9.toSlot)(item)))
        return false;
      switch ((0, import_kolmafia9.toSlot)(item)) {
        case $slot(_templateObject211 || (_templateObject211 = _taggedTemplateLiteral3(["off-hand"]))):
          if (this.equips.has($slot(_templateObject310 || (_templateObject310 = _taggedTemplateLiteral3(["weapon"])))) && weaponHands(this.equips.get($slot(_templateObject410 || (_templateObject410 = _taggedTemplateLiteral3(["weapon"]))))) !== 1) {
            return false;
          }
          break;
        case $slot(_templateObject52 || (_templateObject52 = _taggedTemplateLiteral3(["familiar"]))):
          if (this.familiar !== void 0 && !(0, import_kolmafia9.canEquip)(this.familiar, item))
            return false;
      }
      if ((0, import_kolmafia9.toSlot)(item) !== $slot(_templateObject62 || (_templateObject62 = _taggedTemplateLiteral3(["familiar"]))) && !(0, import_kolmafia9.canEquip)(item))
        return false;
      this.equips.set((0, import_kolmafia9.toSlot)(item), item);
      return true;
    }
  }, {
    key: "equipAccessory",
    value: function equipAccessory(item, slot) {
      var _this = this;
      if (![void 0].concat(_toConsumableArray7($slots(_templateObject72 || (_templateObject72 = _taggedTemplateLiteral3(["acc1, acc2, acc3"]))))).includes(slot))
        return false;
      if ((0, import_kolmafia9.toSlot)(item) !== $slot(_templateObject82 || (_templateObject82 = _taggedTemplateLiteral3(["acc1"]))))
        return false;
      if (!(0, import_kolmafia9.canEquip)(item))
        return false;
      if (slot === void 0) {
        var empty = $slots(_templateObject92 || (_templateObject92 = _taggedTemplateLiteral3(["acc1, acc2, acc3"]))).find(function(s) {
    ...
    value: function equipUsingDualWield(item, slot) {
      if (![void 0, $slot(_templateObject102 || (_templateObject102 = _taggedTemplateLiteral3(["off-hand"])))].includes(slot))
        return false;
      if ((0, import_kolmafia9.toSlot)(item) !== $slot(_templateObject113 || (_templateObject113 = _taggedTemplateLiteral3(["weapon"]))))
        return false;
      if (this.equips.has($slot(_templateObject123 || (_templateObject123 = _taggedTemplateLiteral3(["weapon"])))) && weaponHands(this.equips.get($slot(_templateObject133 || (_templateObject133 = _taggedTemplateLiteral3(["weapon"]))))) !== 1) {
        return false;
      }
      if (this.equips.has($slot(_templateObject143 || (_templateObject143 = _taggedTemplateLiteral3(["off-hand"])))))
        return false;
      if (!have($skill(_templateObject153 || (_templateObject153 = _taggedTemplateLiteral3(["Double-Fisted Skull Smashing"])))))
        return false;
      if (weaponHands(item) !== 1)
        return false;
      if (!(0, import_kolmafia9.canEquip)(item))
        return false;
      this.equips.set($slot(_templateObject163 || (_templateObject163 = _taggedTemplateLiteral3(["off-hand"]))), item);
      return true;
    }
  }, {
    ...
    value: function getHoldingFamiliar(item) {
      switch ((0, import_kolmafia9.toSlot)(item)) {
        case $slot(_templateObject173 || (_templateObject173 = _taggedTemplateLiteral3(["weapon"]))):
          return $familiar(_templateObject183 || (_templateObject183 = _taggedTemplateLiteral3(["Disembodied Hand"])));
        case $slot(_templateObject193 || (_templateObject193 = _taggedTemplateLiteral3(["off-hand"]))):
          return $familiar(_templateObject203 || (_templateObject203 = _taggedTemplateLiteral3(["Left-Hand Man"])));
        default:
          return void 0;
      }
    }
    ...
    value: function equipUsingFamiliar(item, slot) {
      if (![void 0, $slot(_templateObject213 || (_templateObject213 = _taggedTemplateLiteral3(["familiar"])))].includes(slot))
        return false;
      if (this.equips.has($slot(_templateObject223 || (_templateObject223 = _taggedTemplateLiteral3(["familiar"])))))
        return false;
      if ((0, import_kolmafia9.booleanModifier)(item, "Single Equip"))
        return false;
      var familiar = this.getHoldingFamiliar(item);
      if (familiar === void 0 || !this.equip(familiar))
        return false;
      this.equips.set($slot(_templateObject233 || (_templateObject233 = _taggedTemplateLiteral3(["familiar"]))), item);
      return true;
    }
  }, {
    key: "equipItem",
    ...
    value: function equipFamiliar(familiar) {
      ...
      var item = this.equips.get($slot(_templateObject243 || (_templateObject243 = _taggedTemplateLiteral3(["familiar"]))));
      if (item !== void 0 && item !== $item.none && !(0, import_kolmafia9.canEquip)(familiar, item))
        return false;
      this.familiar = familiar;
      return true;
    }
    ...
    value: function equipSpec(spec) {
      ...
      for (var _i = 0, _outfitSlots2 = outfitSlots; _i < _outfitSlots2.length; _i++) {
        ...
        var slot = (_a = (/* @__PURE__ */ new Map([["famequip", $slot(_templateObject253 || (_templateObject253 = _taggedTemplateLiteral3(["familiar"])))], ["offhand", $slot(_templateObject263 || (_templateObject263 = _taggedTemplateLiteral3(["off-hand"])))]])).get(slotName)) !== null && _a !== void 0 ? _a : (0, import_kolmafia9.toSlot)(slotName);
        var itemOrItems = spec[slotName];
        if (itemOrItems !== void 0 && !this.equip(itemOrItems, slot))
          succeeded = false;
      }
      var _iterator22 = _createForOfIteratorHelper8((_b = spec === null || spec === void 0 ? void 0 : spec.equip) !== null && _b !== void 0 ? _b : []), _step22;
      try {
        for (_iterator22.s(); !(_step22 = _iterator22.n()).done; ) {
      ...
      (_this$avoid = this.avoid).push.apply(_this$avoid, _toConsumableArray7((_c = spec === null || spec === void 0 ? void 0 : spec.avoid) !== null && _c !== void 0 ? _c : []));
      this.skipDefaults = this.skipDefaults || ((_d = spec.skipDefaults) !== null && _d !== void 0 ? _d : false);
      if (spec.modifier) {
        var _this$modifier;
        if (Array.isArray(spec.modifier))
          (_this$modifier = this.modifier).push.apply(_this$modifier, _toConsumableArray7(spec.modifier));
        else
      ...
      this.beforeDress.apply(this, _toConsumableArray7((_e = spec.beforeDress) !== null && _e !== void 0 ? _e : []));
      this.afterDress.apply(this, _toConsumableArray7((_f = spec.afterDress) !== null && _f !== void 0 ? _f : []));
      return succeeded;
    }
    /**
    ...
    value: function equipFirst(things, slot) {
      ...
      if (things.length === 0)
        return true;
      return things.some(function(val2) {
        return _this.equip(val2, slot);
      });
    }
    /**
    ...
    value: function equip4(thing, slot) {
      ...
      if (Array.isArray(thing)) {
        ...
        return thing.every(function(val2) {
          return _this.equip(val2);
        });
      }
      if (thing instanceof import_kolmafia9.Item)
        return this.equipItem(thing, slot);
      if (thing instanceof import_kolmafia9.Familiar)
    ...
    value: function bjornify(target) {
      return this.equipRider(target, $slot(_templateObject273 || (_templateObject273 = _taggedTemplateLiteral3(["buddy-bjorn"]))));
    }
    /**
    ...
    value: function enthrone(target) {
      return this.equipRider(target, $slot(_templateObject283 || (_templateObject283 = _taggedTemplateLiteral3(["crown-of-thrones"]))));
    }
    /**
    ...
    value: function setModes(modes) {
      var _a, _b;
      var compatible = true;
      for (var _i22 = 0, _modeableCommands = modeableCommands2; _i22 < _modeableCommands.length; _i22++) {
        var mode = _modeableCommands[_i22];
        if (mode === "retrocape")
          continue;
    ...
    value: function _dress(refreshed) {
      var _this = this;
      if (this.familiar)
        (0, import_kolmafia9.useFamiliar)(this.familiar);
      var targetEquipment = Array.from(this.equips.values());
      var usedSlots = /* @__PURE__ */ new Set();
      var nonaccessorySlots = $slots(_templateObject293 || (_templateObject293 = _taggedTemplateLiteral3(["weapon, off-hand, hat, back, shirt, pants, familiar"])));
      var bjorn = this.riders.get($slot(_templateObject303 || (_templateObject303 = _taggedTemplateLiteral3(["buddy-bjorn"]))));
      if (bjorn && (this.equips.get($slot(_templateObject313 || (_templateObject313 = _taggedTemplateLiteral3(["back"])))) === $item(_templateObject323 || (_templateObject323 = _taggedTemplateLiteral3(["Buddy Bjorn"]))) || this.getBonus($item(_templateObject333 || (_templateObject333 = _taggedTemplateLiteral3(["Buddy Bjorn"])))))) {
        usedSlots.add($slot(_templateObject343 || (_templateObject343 = _taggedTemplateLiteral3(["buddy-bjorn"]))));
        usedSlots.add($slot(_templateObject353 || (_templateObject353 = _taggedTemplateLiteral3(["crown-of-thrones"]))));
      }
      var crown = this.riders.get($slot(_templateObject363 || (_templateObject363 = _taggedTemplateLiteral3(["crown-of-thrones"]))));
      if (crown && (this.equips.get($slot(_templateObject372 || (_templateObject372 = _taggedTemplateLiteral3(["hat"])))) === $item(_templateObject382 || (_templateObject382 = _taggedTemplateLiteral3(["Crown of Thrones"]))) || this.getBonus($item(_templateObject392 || (_templateObject392 = _taggedTemplateLiteral3(["Crown of Thrones"])))))) {
        usedSlots.add($slot(_templateObject402 || (_templateObject402 = _taggedTemplateLiteral3(["buddy-bjorn"]))));
        usedSlots.add($slot(_templateObject412 || (_templateObject412 = _taggedTemplateLiteral3(["crown-of-thrones"]))));
      }
      var _iterator3 = _createForOfIteratorHelper8(nonaccessorySlots), _step3;
      try {
        for (_iterator3.s(); !(_step3 = _iterator3.n()).done; ) {
          var slot = _step3.value;
          if (targetEquipment.includes((0, import_kolmafia9.equippedItem)(slot)) && this.equips.get(slot) !== (0, import_kolmafia9.equippedItem)(slot) || this.avoid.includes((0, import_kolmafia9.equippedItem)(slot)) || slot === $slot(_templateObject492 || (_templateObject492 = _taggedTemplateLiteral3(["weapon"]))) && weaponHands((0, import_kolmafia9.equippedItem)(slot)) !== 1 && this.equips.has($slot(_templateObject502 || (_templateObject502 = _taggedTemplateLiteral3(["offhand"])))) && !this.equips.has($slot(_templateObject512 || (_templateObject512 = _taggedTemplateLiteral3(["weapon"])))))
            (0, import_kolmafia9.equip)(slot, $item.none);
        }
      } catch (err) {
        _iterator3.e(err);
      } finally {
      ...
      try {
        for (_iterator4.s(); !(_step4 = _iterator4.n()).done; ) {
          ...
          if (equipment) {
            (0, import_kolmafia9.equip)(_slot, equipment);
            usedSlots.add(_slot);
          }
        }
      } catch (err) {
      ...
      var accessorySlots = $slots(_templateObject422 || (_templateObject422 = _taggedTemplateLiteral3(["acc1, acc2, acc3"])));
      ...
      try {
        var _loop = function _loop3() {
          ...
          var alreadyEquipped = accessorySlots.find(function(slot2) {
            return !usedSlots.has(slot2) && (0, import_kolmafia9.equippedItem)(slot2) === accessory2;
          });
          if (alreadyEquipped) {
      ...
      for (var _i3 = 0, _missingAccessories = missingAccessories; _i3 < _missingAccessories.length; _i3++) {
        ...
        (0, import_kolmafia9.equip)(unusedSlot, accessory);
      ...
      if (this.modifier.length > 0 || _toConsumableArray7(this.bonuses).filter(function(_ref5) {
        ...
        if (!Requirement.merge(allRequirements).maximize()) {
          if (!refreshed) {
            (0, import_kolmafia9.cliExecute)("refresh inventory");
            this._dress(true);
            return;
          } else
      ...
      applyModes(modes);
      if (bjorn && (0, import_kolmafia9.haveEquipped)($item(_templateObject432 || (_templateObject432 = _taggedTemplateLiteral3(["Buddy Bjorn"]))))) {
        if ((0, import_kolmafia9.myEnthronedFamiliar)() === bjorn)
          (0, import_kolmafia9.enthroneFamiliar)($familiar.none);
        if ((0, import_kolmafia9.myBjornedFamiliar)() !== bjorn)
          (0, import_kolmafia9.bjornifyFamiliar)(bjorn);
      }
      if (crown && (0, import_kolmafia9.haveEquipped)($item(_templateObject442 || (_templateObject442 = _taggedTemplateLiteral3(["Crown of Thrones"]))))) {
        if ((0, import_kolmafia9.myBjornedFamiliar)() === crown)
          (0, import_kolmafia9.bjornifyFamiliar)($familiar.none);
        if ((0, import_kolmafia9.myEnthronedFamiliar)() !== crown)
          (0, import_kolmafia9.enthroneFamiliar)(crown);
      }
      if (this.familiar !== void 0 && (0, import_kolmafia9.myFamiliar)() !== this.familiar)
      ...
      try {
        for (_iterator6.s(); !(_step6 = _iterator6.n()).done; ) {
          ...
          if (this.equips.has(_slot2) && (0, import_kolmafia9.equippedItem)(_slot2) !== this.equips.get(_slot2)) {
      ...
      try {
        var _loop2 = function _loop22() {
          ...
          if ((0, import_kolmafia9.equippedAmount)(accessory2) < accessoryEquips.filter(function(acc) {
      ...
      for (var _i4 = 0, _arr = [[$slot(_templateObject452 || (_templateObject452 = _taggedTemplateLiteral3(["buddy-bjorn"]))), $item(_templateObject462 || (_templateObject462 = _taggedTemplateLiteral3(["Buddy Bjorn"]))), import_kolmafia9.myBjornedFamiliar], [$slot(_templateObject472 || (_templateObject472 = _taggedTemplateLiteral3(["crown-of-thrones"]))), $item(_templateObject482 || (_templateObject482 = _taggedTemplateLiteral3(["Crown of Thrones"]))), import_kolmafia9.myEnthronedFamiliar]]; _i4 < _arr.length; _i4++) {
    ...
    value: function clone() {
      ...
      result.modifier = _toConsumableArray7(this.modifier);
      result.avoid = _toConsumableArray7(this.avoid);
      result.modes = _objectSpread4({}, this.modes);
      result.riders = new Map(this.riders);
      result.bonuses = new Map(this.bonuses);
      result.beforeDress.apply(result, _toConsumableArray7(this.preActions));
      result.afterDress.apply(result, _toConsumableArray7(this.postActions));
      return result;
    }
    /**
    ...
    value: function spec() {
      ...
      for (var _i5 = 0, _outfitSlots2 = outfitSlots; _i5 < _outfitSlots2.length; _i5++) {
        ...
        var entry = this.equips.get((_a = (/* @__PURE__ */ new Map([["famequip", $slot(_templateObject522 || (_templateObject522 = _taggedTemplateLiteral3(["familiar"])))], ["offhand", $slot(_templateObject53 || (_templateObject53 = _taggedTemplateLiteral3(["off-hand"])))]])).get(slotName)) !== null && _a !== void 0 ? _a : (0, import_kolmafia9.toSlot)(slotName));
        if (entry)
          result[slotName] = entry;
      }
      var riders = {};
      var buddyRider = this.riders.get($slot(_templateObject54 || (_templateObject54 = _taggedTemplateLiteral3(["buddy-bjorn"]))));
      if (buddyRider !== void 0)
        riders["buddy-bjorn"] = buddyRider;
      var throneRider = this.riders.get($slot(_templateObject55 || (_templateObject55 = _taggedTemplateLiteral3(["crown-of-thrones"]))));
    ...
    value: function current() {
      ...
      var familiar = (0, import_kolmafia9.myFamiliar)();
      ...
      for (var _i6 = 0, _outfitSlots3 = outfitSlots; _i6 < _outfitSlots3.length; _i6++) {
        ...
        var slot = (_a = (/* @__PURE__ */ new Map([["famequip", $slot(_templateObject56 || (_templateObject56 = _taggedTemplateLiteral3(["familiar"])))], ["offhand", $slot(_templateObject57 || (_templateObject57 = _taggedTemplateLiteral3(["off-hand"])))]])).get(slotName)) !== null && _a !== void 0 ? _a : (0, import_kolmafia9.toSlot)(slotName);
      ...
      if ((0, import_kolmafia9.haveEquipped)($item(_templateObject58 || (_templateObject58 = _taggedTemplateLiteral3(["Crown of Thrones"])))))
        outfit2.riders.set($slot(_templateObject59 || (_templateObject59 = _taggedTemplateLiteral3(["crown-of-thrones"]))), (0, import_kolmafia9.myEnthronedFamiliar)());
      if ((0, import_kolmafia9.haveEquipped)($item(_templateObject60 || (_templateObject60 = _taggedTemplateLiteral3(["Buddy Bjorn"])))))
        outfit2.riders.set($slot(_templateObject61 || (_templateObject61 = _taggedTemplateLiteral3(["buddy-bjorn"]))), (0, import_kolmafia9.myBjornedFamiliar)());
...
function _slicedToArray6(arr, i2) {
  return _arrayWithHoles6(arr) || _iterableToArrayLimit6(arr, i2) || _unsupportedIterableToArray10(arr, i2) || _nonIterableRest6();
}
...
var Engine = /* @__PURE__ */ function() {
  ...
  _createClass9(Engine2, [{
    ...
    value: function run(actions) {
      for (var i2 = 0; i2 < (actions !== null && actions !== void 0 ? actions : Infinity); i2++) {
    ...
    value: function destruct() {
      ...
      (0, import_kolmafia10.setAutoAttack)(0);
    }
    /**
    ...
    value: function available(task) {
      ...
      if (((_a = task.limit) === null || _a === void 0 ? void 0 : _a.skip) !== void 0 && this.attempts[task.name] >= task.limit.skip)
        return false;
      var _iterator22 = _createForOfIteratorHelper9((_b = task.after) !== null && _b !== void 0 ? _b : []), _step22;
      try {
        for (_iterator22.s(); !(_step22 = _iterator22.n()).done; ) {
    ...
    value: function execute(task) {
      var _a, _b, _c, _d, _e;
      (0, import_kolmafia10.print)("");
      (0, import_kolmafia10.print)("Executing ".concat(task.name), "blue");
    ...
    value: function acquireItems(task) {
      ...
      try {
        for (_iterator4.s(); !(_step4 = _iterator4.n()).done; ) {
          ...
          var num_have = (0, import_kolmafia10.itemAmount)(to_get.item) + (0, import_kolmafia10.equippedAmount)(to_get.item);
          ...
          if (to_get.get) {
            ...
            (0, import_kolmafia10.buy)(to_get.item, num_needed - num_have, to_get.price);
          } else if (Object.keys((0, import_kolmafia10.getRelated)(to_get.item, "fold")).length > 0) {
            (0, import_kolmafia10.cliExecute)("fold ".concat(to_get.item));
          } else {
            (0, import_kolmafia10.retrieveItem)(to_get.item, num_needed);
          }
          if ((0, import_kolmafia10.itemAmount)(to_get.item) + (0, import_kolmafia10.equippedAmount)(to_get.item) < num_needed && !to_get.optional) {
    ...
    value: function acquireEffects(task) {
      ...
      var extraSongs = Object.keys((0, import_kolmafia10.myEffects)()).map(function(effectName) {
        return (0, import_kolmafia10.toEffect)(effectName);
    ...
    value: function dress(task, outfit2) {
      if (task.do instanceof import_kolmafia10.Location)
        (0, import_kolmafia10.setLocation)(task.do);
      outfit2.dress();
    }
    ...
    value: function setCombat(task, task_combat, task_resources) {
      var _a;
      var macro = task_combat.compile(task_resources, (_a = this.options) === null || _a === void 0 ? void 0 : _a.combat_defaults, task.do instanceof import_kolmafia10.Location ? task.do : void 0);
      macro.save();
      if (!this.options.ccs) {
        var otherCCSEntries = task_combat.compileCcs();
        var ccsContents = ["[default]", '"'.concat(macro.toString(), '"')].concat(_toConsumableArray8(otherCCSEntries)).join("\n");
        (0, import_kolmafia10.logprint)("CCS: ".concat(ccsContents.replace("\n", "\\n ")));
        if (ccsContents !== this.cachedCcsContents) {
          (0, import_kolmafia10.writeCcs)(ccsContents, grimoireCCS);
          (0, import_kolmafia10.cliExecute)("ccs ".concat(grimoireCCS));
          this.cachedCcsContents = ccsContents;
        }
      }
      var autoattack = task_combat.compileAutoattack();
      if (autoattack.toString().length > 1) {
        (0, import_kolmafia10.logprint)("Autoattack macro: ".concat(autoattack.toString()));
    ...
    value: function _do(task) {
      ...
      if (result instanceof import_kolmafia10.Location)
        (0, import_kolmafia10.adv1)(result, -1, "");
      (0, import_kolmafia10.runCombat)();
      while ((0, import_kolmafia10.inMultiFight)())
        (0, import_kolmafia10.runCombat)();
      if ((0, import_kolmafia10.choiceFollowsFight)())
        (0, import_kolmafia10.runChoice)(-1);
    }
    /**
    ...
    value: function shouldRepeatAdv(task) {
      return task.do instanceof import_kolmafia10.Location && lastEncounterWasWanderingNC();
    }
    /**
    ...
    value: function checkLimits(task, postcondition) {
      ...
      if (!task.completed()) {
        ...
        if (task.limit.turns && task.do instanceof import_kolmafia10.Location && task.do.turnsSpent >= task.limit.turns)
    ...
    value: function initPropertiesManager(manager) {
      ...
      if (this.options.ccs !== "") {
        if (this.options.ccs === void 0 && (0, import_kolmafia10.readCcs)(grimoireCCS) === "") {
          (0, import_kolmafia10.writeCcs)("[ default ]\nabort", grimoireCCS);
        }
        manager.set({
...
function maxSongs() {
  return have($skill(_templateObject63 || (_templateObject63 = _taggedTemplateLiteral4(["Mariachi Memory"])))) ? 4 : 3;
}
...
var zoneSpecificNCs = /* @__PURE__ */ new Map([
  ["The Horror...", $locations(_templateObject214 || (_templateObject214 = _taggedTemplateLiteral4(["Frat House"])))]
...
var import_mafia_shared_relay = __toESM(require_dist());
...
function convertArgsToHtml() {
  ...
  metadata.traverse(function(key, name) {
    var _key$key, _key$setting, _key$key2;
    if (key.setting === "" || key.hidden)
      return;
    var component2 = {
      type: "string",
      ...
      default: "default" in key ? "".concat(key["default"]) : void 0
    };
    if (key.valueHelpName === "FLAG" || key.valueHelpName === "BOOLEAN") {
      component2.type = "boolean";
    } else if (key.options !== void 0) {
      component2.type = "dropdown";
      component2.dropdown = key.options.map(function(_ref) {
        var _ref2 = _slicedToArray7(_ref, 2), k = _ref2[0], desc = _ref2[1];
        return {
    ...
    pages[pages.length - 1].components.push(component2);
  }, function(group, name) {
    pages.push({
      page: group.name,
      file: name,
...
function main() {
  if ((0, import_mafia_shared_relay.handleApiRequest)())
    return;
  (0, import_kolmafia11.write)((0, import_mafia_shared_relay.generateHTML)(convertArgsToHtml()));
}
